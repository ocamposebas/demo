...
const COPY = {
  es: {
    ...
    welcomeOfferText: "Al crear tu cuenta, WooCommerce generará un código personal del 10% cuando esta función esté habilitada por el administrador.",
    ...
    accountCreated: "Cuenta creada correctamente. Tu sesión ya está activa.",
  ...
  en: {
    ...
    welcomeOfferText: "When you create an account, WooCommerce will generate a personal 10% code when enabled by the administrator.",
    ...
    accountCreated: "Account created. Your session is now active.",
